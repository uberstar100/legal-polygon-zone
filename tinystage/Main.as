package 
{
    ...
    dynamic public class Main extends SSF2Asset
    {
        ...
        public function Main()
        {
            ...
            register("resources", {movieclips:["stage_tinystage", "tinystage_bg"], sounds:[]});
            register("music", [{id:"bgm_polygonzone"}, {id:"bgm_polygonbattle"}]);
            register("stage", tinystage);
            register("camera", {x_start:280, y_start:250, backgrounds:[{linkage_id:"tinystage_bg"}]});
            return;
        }// end function
